...
public class AuthController {
    ...
    public ResponseEntity<ProfileDto> updateMe(Authentication auth, @RequestBody ProfileUpdateRequest req) {
        User updated = authService.updateProfile(
                auth.getName(), req.name(), req.telefono(), req.rut(), req.direccion(), req.inicioResidencia());
    ...
    public record ProfileUpdateRequest(String name, String telefono, String rut, String direccion, LocalDate inicioResidencia) {}
